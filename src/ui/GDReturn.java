...
public class GDReturn extends JFrame implements ActionListener{
	public static int WIDTH = 720;
	public static int HEIGHT = 436;
	
	private Box box, viewModeBox;
	private JButton btnBack, btnReturn;
	private DefaultTableModel tableModel;
	private JTable table;
	
	
	public GDReturn(String title) {
		super(title);
		mapWidgets();
		handleEvents();
	...
	private void showBorrowedBook() {
		...
		LinkedList temp = GiaoDien.list.getBorrowingBook();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnReturn) {
			...
			GiaoDien.list.getBookByID(idx).setStatus(true);
			showBorrowedBook();
			btnReturn.setEnabled(false);
		}
	}
